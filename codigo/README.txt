...
./tp2 -m [Modo de uso] -i [archivo de entrada train] -q [archivo de entrada test] -o [archivo de salida]  -k (k de kNN) -a (alpha de PCA, depende de modo) -r(archivo de salida de mediciones) -e (experimentación)
